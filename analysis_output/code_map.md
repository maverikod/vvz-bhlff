...
Physical Me...
  ...
  - 🔒 `_setup_basic_material_constants()`
...
- **BVBBasicCore**
  - Наследование: AbstractSolverCore
  - Описание: Core basic BVP solver functionality.

Physical Meaning:
    Implements core basic mathematical opera...
