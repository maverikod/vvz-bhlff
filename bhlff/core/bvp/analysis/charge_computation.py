...
class ChargeComputation:
    ...
    def _compute_winding_cuda(self, phase: cp.ndarray, gradients: List[cp.ndarray]) -> cp.ndarray:
    ...
    def _compute_winding_cpu(self, phase: np.ndarray, gradients: List[np.ndarray]) -> np.ndarray:
    ...
    def find_charge_locations(self, phase_block: np.ndarray, block_offset: int = 0) -> List[Tuple[int, ...]]:
        """
