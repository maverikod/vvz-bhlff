...
class BVPConstants:
    ...
    def compute_nonlinear_admittance_coefficients(self, frequency: float, amplitude: float) -> Dict[str, float]:
        ...
        base_admittance = self.get_material_property("base_admittance")
        ...
        y1_base = self.get_material_property("admittance_coeff_1")
        ...
        y2_base = self.get_material_property("admittance_coeff_2")
        ...
        y3_base = self.get_material_property("admittance_coeff_3") * 0.1
    ...
    def compute_renormalized_coefficients(self, amplitude: float, gradient_magnitude_squared: float) -> Dict[str, float]:
        ...
        c0 = self.get_material_property("renorm_coeff_0")
        c1 = self.get_material_property("renorm_coeff_1")
        c2 = self.get_material_property("renorm_coeff_2")
