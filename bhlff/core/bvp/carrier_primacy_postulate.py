...
class CarrierPrimacyPostulate(BVPPostulate):
    ...
    def __init__(self, domain: Domain, constants: BVPConstants):
        ...
        self.scale_separation_threshold = constants.get_quench_parameter("scale_separation_threshold", 10.0)
    ...
    def _find_dominant_frequencies(self, spectrum: np.ndarray, freq_axis: np.ndarray) -> Dict[str, float]:
        """
    ...
    def _compute_frequency_statistics(self, spectrum: np.ndarray, freq_axis: np.ndarray) -> Dict[str, float]:
        """
        Compute frequency statistics.
    ...
    def _check_scale_separation(self, frequency_analysis: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "separation_quality": min(frequency_ratio / self.scale_separation_threshold, 1.0)
        }
    ...
    def _validate_carrier_primacy(self, scale_separation: Dict[str, Any], 
                                modulation_analysis: Dict[str, Any]) -> bool:
        """
