...
class BVPEnvelopeEquation7D:
    ...
    def solve_envelope(self, source_7d: np.ndarray, 
        ...
        def jacobian_func(envelope):
            ...
            return self.solver_core.compute_jacobian_sparse(
                envelope, dkappa_da, dchi_da, 
                self.derivative_operators, self.nonlinear_terms
            )
    ...
    def analyze_solution_quality(self, envelope: np.ndarray, source: np.ndarray) -> Dict[str, Any]:
        """
