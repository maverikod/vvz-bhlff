...
class EnvelopeSolverCoreBasic(AbstractSolverCore):
    ...
    def _solve_linear_system(self, jacobian: csc_matrix, residual: np.ndarray) -> np.ndarray:
        """
    ...
    def _compute_jacobian_row(self, solution: np.ndarray, idx: Tuple[int, ...]) -> Dict[int, float]:
        """
