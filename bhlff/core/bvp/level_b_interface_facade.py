...
class LevelBInterface(BVPLevelInterface):
    ...
    def process_bvp_data(self, envelope: np.ndarray, **kwargs) -> Dict[str, Any]:
        ...
        charge_data = self.topological_charge_analyzer.compute_topological_charge(envelope)
    ...
    def get_detailed_analysis(self, envelope: np.ndarray) -> Dict[str, Any]:
        ...
        phase_structure = self.topological_charge_analyzer.analyze_phase_structure(envelope)
        zone_statistics = self.zone_separation_analyzer.compute_zone_statistics(envelope)
    ...
    def validate_level_b_properties(self, envelope: np.ndarray) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_valid": power_law_valid and nodes_valid and charge_valid and zones_valid,
            "validation_details": {
