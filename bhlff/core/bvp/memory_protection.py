...
class MemoryProtector:
    ...
    def check_memory_usage(self, domain_shape: Tuple[int, ...], data_type: np.dtype = np.float64) -> bool:
        """
    ...
    def estimate_memory_requirement(self, domain_shape: Tuple[int, ...], data_type: np.dtype = np.float64) -> dict:
        """
    ...
    def check_and_warn(self, domain_shape: Tuple[int, ...], data_type: np.dtype = np.float64) -> bool:
        """
