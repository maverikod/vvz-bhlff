...
class OptimizationMethods:
    ...
    def fit_using_curve_fit(self, radial_profile: Dict[str, np.ndarray]) -> Dict[str, Any]:
        """
    ...
    def fit_using_minimize(self, radial_profile: Dict[str, np.ndarray]) -> Dict[str, Any]:
        """
    ...
    def fit_using_custom_optimization(self, radial_profile: Dict[str, np.ndarray]) -> Dict[str, Any]:
        """
