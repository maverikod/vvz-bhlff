...
class QuenchCharacteristics:
    ...
    def compute_quench_strength(self, component_mask: np.ndarray, amplitude: np.ndarray) -> float:
        """
    ...
    def compute_detuning_strength(self, component_mask: np.ndarray, detuning: np.ndarray) -> float:
        """
    ...
    def compute_gradient_strength(self, component_mask: np.ndarray, gradient_magnitude: np.ndarray) -> float:
        """
