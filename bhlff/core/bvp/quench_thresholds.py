...
class QuenchThresholdComputer:
    ...
    def compute_amplitude_threshold(self) -> float:
        ...
        L_spatial = np.sqrt(spatial_config.L_x**2 + spatial_config.L_y**2 + spatial_config.L_z**2)
        L_phase = np.sqrt(phase_config.phi_1_max**2 + phase_config.phi_2_max**2 + phase_config.phi_3_max**2)
