...
class ScaleSeparationPostulate(BVPPostulate):
    ...
    def apply(self, envelope: np.ndarray, **kwargs) -> Dict[str, Any]:
        ...
        scale_separation = self._check_scale_separation(length_scale_analysis, carrier_wavelength)
    ...
    def _check_scale_separation(self, length_scale_analysis: Dict[str, Any], 
                              carrier_wavelength: float) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "separation_quality": min(min_scale_ratio / self.scale_separation_threshold, 1.0)
        }
