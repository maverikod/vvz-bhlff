...
class BVPCoreSolver(AbstractSolverCore):
    ...
    def __init__(self, domain: 'Domain7DBVP', parameters: 'Parameters7DBVP', derivatives: 'SpectralDerivatives'):
        ...
        self.energy_conservation_check = parameters.get('energy_conservation_check', True)
    ...
    def solve_envelope_comprehensive(self, source: np.ndarray) -> np.ndarray:
        ...
        for iteration in range(self.max_iterations):
            ...
            raise RuntimeError(f"Solution failed to converge after {self.max_iterations} iterations")
    ...
    def _validate_theoretical_consistency(self, solution: np.ndarray, source: np.ndarray) -> None:
        """
    ...
    def _compute_energy_balance(self, solution: np.ndarray, source: np.ndarray) -> float:
        """
    ...
    def solve_envelope_basic(self, source: np.ndarray) -> np.ndarray:
        ...
        """
        self.logger.info("Using legacy basic envelope equation solution")
