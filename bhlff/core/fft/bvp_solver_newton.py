...
class BVPSolverNewton:
    ...
    def solve(self, source_field: np.ndarray, initial_guess: Optional[np.ndarray] = None) -> np.ndarray:
        """
    ...
    def _solve_linearized(self, source_field: np.ndarray) -> np.ndarray:
        ...
        source_spectral = spectral_ops.forward_fft(source_field, normalization='physics')
