...
class FFTSolver7DBVP:
    ...
    def solve_envelope(self, source_field: np.ndarray, 
        ...
        if method == 'linearized':
            return self._newton_solver._solve_linearized(source_field)
        elif method == 'newton_raphson':
            return self._newton_solver.solve(source_field, initial_guess)
        else:
    ...
    def validate_solution(self, solution: np.ndarray, source: np.ndarray,
        ...
        """
        return self._validator.validate_solution(solution, source, tolerance, method)
    ...
    def check_energy_conservation(self, field: np.ndarray, 
        ...
        """
        return self._validator.check_energy_conservation(field, expected_energy, tolerance)
