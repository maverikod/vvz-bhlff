...
class SpectralCoefficientCache:
    ...
    def __init__(self, max_cache_size: int = 100):
        ...
        self.logger.info(f"SpectralCoefficientCache initialized: max_size={max_cache_size}")
    ...
    def optimize_cache(self) -> None:
        ...
        self.logger.info(f"Cache optimization complete: {entries_to_remove} entries removed")
    
    def _create_cache_key(self, mu: float, beta: float, lambda_param: float, 
                         domain_shape: Tuple[int, ...]) -> str:
        """
    ...
    def _add_to_cache(self, cache_key: str, coefficients: np.ndarray) -> None:
        ...
        self.logger.debug(f"Added coefficients to cache: key={cache_key[:8]}..., "
    ...
    def get_memory_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'average_entry_size_mb': (self.memory_usage / max(1, len(self.cache))) / 1024**2
        }
