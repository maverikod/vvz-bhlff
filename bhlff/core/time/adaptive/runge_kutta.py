...
class RungeKuttaMethods:
    ...
    def embedded_rk_step(
        ...
        # Compute k5
        field_temp = field + dt * (a[4, 0] * k1 + a[4, 1] * k2 + a[4, 2] * k3 + a[4, 3] * k4)
        k5 = compute_rhs(field_temp, source)
        
        # Compute k6
        field_temp = field + dt * (a[5, 0] * k1 + a[5, 1] * k2 + a[5, 2] * k3 + a[5, 3] * k4 + a[5, 4] * k5)
        k6 = compute_rhs(field_temp, source)
        
        # Compute k7
        field_temp = field + dt * (a[6, 0] * k1 + a[6, 1] * k2 + a[6, 2] * k3 + a[6, 3] * k4 + a[6, 4] * k5 + a[6, 5] * k6)
        k7 = compute_rhs(field_temp, source)
        
        # Fourth-order solution
        field_4th = field + dt * (b4[0] * k1 + b4[1] * k2 + b4[2] * k3 + b4[3] * k4 + b4[4] * k5 + b4[5] * k6 + b4[6] * k7)
        
        # Fifth-order solution
        field_5th = field + dt * (b5[0] * k1 + b5[1] * k2 + b5[2] * k3 + b5[3] * k4 + b5[4] * k5 + b5[5] * k6 + b5[6] * k7)
