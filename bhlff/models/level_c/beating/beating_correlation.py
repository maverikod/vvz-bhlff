...
class BeatingCorrelationAnalyzer:
    ...
    def calculate_variance_analysis(self, envelope: np.ndarray) -> Dict[str, Any]:
        ...
        variance_stats = self._calculate_variance_statistics(overall_variance, local_variance)
    ...
    def _calculate_variance_statistics(self, overall_variance: float, local_variance: np.ndarray) -> Dict[str, float]:
        """
        Calculate variance statistics.
