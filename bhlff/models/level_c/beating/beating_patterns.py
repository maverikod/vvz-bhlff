...
class BeatingPatternDetector:
    ...
    def calculate_pattern_detection(self, envelope: np.ndarray) -> Dict[str, Any]:
        ...
        pattern_stats = self._calculate_pattern_statistics(temporal_patterns, spatial_patterns, phase_patterns)
    ...
    def _calculate_pattern_statistics(self, temporal_patterns: List[Dict[str, Any]], 
                                    spatial_patterns: List[Dict[str, Any]], 
                                    phase_patterns: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        Calculate pattern statistics.
        ...
        return {
            ...
            'total_patterns': len(temporal_patterns) + len(spatial_patterns) + len(phase_patterns)
        }
