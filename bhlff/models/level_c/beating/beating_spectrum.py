...
class BeatingSpectrumAnalyzer:
    ...
    def calculate_beating_spectrum(self, envelope: np.ndarray) -> Dict[str, Any]:
        ...
        interference_patterns = self._calculate_interference_patterns(envelope, beating_frequencies)
        
        # Calculate spectrum statistics
        spectrum_stats = self._calculate_spectrum_statistics(frequency_spectrum, beating_frequencies)
        ...
        self.logger.info(f"Beating spectrum calculated. Found {len(beating_frequencies)} beating frequencies")
        return results
    ...
    def _calculate_beating_frequencies(self, frequency_spectrum: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
    ...
    def _calculate_interference_patterns(self, envelope: np.ndarray, beating_frequencies: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        for beating_freq in beating_frequencies:
            ...
            pattern = self._calculate_single_interference_pattern(envelope, freq, amplitude)
            interference_patterns[f'pattern_{freq}'] = pattern
        
        # Calculate overall interference statistics
        interference_stats = self._calculate_interference_statistics(interference_patterns)
        
        return {
            'patterns': interference_patterns,
            'statistics': interference_stats
        }
    
    def _calculate_spectrum_statistics(self, frequency_spectrum: Dict[str, Any], beating_frequencies: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        Calculate spectrum statistics.
        ...
        return {
            'frequency_spectrum': freq_stats,
            'beating_frequencies': beating_stats
        }
    ...
    def _calculate_single_interference_pattern(self, envelope: np.ndarray, frequency: float, amplitude: float) -> Dict[str, Any]:
        """
        ...
        interference_pattern = amplitude * np.sin(2 * np.pi * frequency * np.arange(len(envelope.flatten())))
    ...
    def _calculate_interference_statistics(self, interference_patterns: Dict[str, Any]) -> Dict[str, Any]:
        """
