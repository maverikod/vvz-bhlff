    ...
    def _get_pattern_feature_importance(self, model) -> Dict[str, float]:
        ...
        try:
            if hasattr(model, 'feature_importances_'):
                feature_names = [
                    "envelope_energy", "envelope_max", "envelope_mean", "envelope_std",
                    "spectrum_peak", "spectrum_std", "spectrum_entropy",
                    "frequency_spacing", "frequency_bandwidth",
                    "symmetry_score", "regularity_score", "complexity_score"
                ]
                importance_dict = {}
