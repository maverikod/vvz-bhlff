    ...
    def predict_frequencies(self, envelope: np.ndarray) -> Dict[str, Any]:
        ...
        try:
            ...
            if model is not None and scaler is not None:
                ...
                confidence = self._compute_prediction_confidence(phase_features_scaled, model)
                uncertainty = self._compute_prediction_uncertainty(phase_features_scaled, model)
            ...
            return {"predicted_frequencies": [0.0, 0.0, 0.0], "prediction_confidence": 0.0}
