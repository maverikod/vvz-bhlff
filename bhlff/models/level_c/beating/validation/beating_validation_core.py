...
class BeatingValidationCore:
    ...
    def validate_with_statistics(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        overall_validation = self.statistics.compute_overall_statistical_validation(validation_results)
    ...
    def _validate_beating_frequencies(self, frequencies: List[float]) -> Dict[str, Any]:
        ...
        physically_reasonable = self._check_frequency_physical_reasonableness(frequencies)
        ...
        # Validation criteria
        valid = physically_reasonable and std_freq < mean_freq * 0.5  # Reasonable variation
