...
class AdmittanceResonanceAnalyzer:
    ...
    def _analyze_resonance_peak(self, spectrum: AdmittanceSpectrum, peak_index: int) -> Dict[str, Any]:
        """
    ...
    def _compute_quality_factor(self, spectrum: AdmittanceSpectrum, peak_index: int) -> float:
        """
        Compute quality factor.
        ...
        # Calculate resonance width
        resonance_width = spectrum.frequencies[right_boundary] - spectrum.frequencies[left_boundary]
    ...
    def _find_left_boundary(self, spectrum: AdmittanceSpectrum, peak_index: int, half_maximum: float) -> int:
        """
    ...
    def _find_right_boundary(self, spectrum: AdmittanceSpectrum, peak_index: int, half_maximum: float) -> int:
        """
    ...
    def _calculate_resonance_width(self, spectrum: AdmittanceSpectrum, peak_index: int) -> float:
        """
        Calculate resonance width.
    ...
    def _calculate_resonance_strength(self, spectrum: AdmittanceSpectrum, peak_index: int) -> float:
        """
        Calculate resonance strength.
