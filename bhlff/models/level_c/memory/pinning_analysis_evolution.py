...
class PinningEvolutionAnalyzer:
    ...
    def evolve_with_pinning(
        self, field: np.ndarray, pinning_potential: np.ndarray, time_params: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        for step in range(num_steps):
            ...
            pinning_force = self._compute_pinning_force(current_field, pinning_potential)
    ...
    def _compute_pinning_force(self, field: np.ndarray, pinning_potential: np.ndarray) -> np.ndarray:
        """
        Compute pinning force.
