...
class DefectModel(ABC):
    ...
    def _compute_defect_force(self, position: np.ndarray, 
    ...
    def _interpolate_potential(self, position: np.ndarray, 
...
class MultiDefectSystem(DefectModel):
    ...
    def _compute_pair_force(self, defect1: Dict[str, Any], 
                           defect2: Dict[str, Any]) -> np.ndarray:
