...
class MultiParticleSystemAnalyzer:
    ...
    def validate_system_analysis(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        potential_validation = self._validate_potential_analysis(results.get("system_energy", {}))
        
        # Validate mode spectrum
        mode_spectrum_validation = self._validate_mode_spectrum(results.get("system_stability", {}))
        
        # Validate system energy
        system_energy_validation = self._validate_system_energy(results.get("system_energy", {}))
        
        # Validate system stability
        system_stability_validation = self._validate_system_stability(results.get("system_stability", {}))
        
        # Calculate overall validation
        overall_validation = self._calculate_overall_validation(
            potential_validation, mode_spectrum_validation, 
            system_energy_validation, system_stability_validation
        )
    ...
    def _calculate_overall_validation(
        self, potential_validation: Dict[str, Any], mode_spectrum_validation: Dict[str, Any],
        system_energy_validation: Dict[str, Any], system_stability_validation: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        Calculate overall validation.
