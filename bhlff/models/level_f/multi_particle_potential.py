...
class MultiParticlePotentialAnalyzer:
    ...
    def _compute_pair_interaction(self, particle1: Particle, particle2: Particle) -> np.ndarray:
        """
    ...
    def _compute_three_body_interaction(self, particle1: Particle, particle2: Particle, particle3: Particle) -> np.ndarray:
        """
        ...
        interaction_strength = self._calculate_three_body_strength(distance_12, distance_13, distance_23)
