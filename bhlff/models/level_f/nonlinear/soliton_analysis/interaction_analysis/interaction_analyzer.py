...
class SolitonInteractionAnalyzer(SolitonAnalysisBase):
    ...
    def analyze_two_soliton_interactions(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if distance < interaction_range:
                interaction_efficiency = interaction_strength / (amp1 * amp2) if (amp1 * amp2) > 0 else 0.0
            else:
    ...
    def analyze_three_soliton_interactions(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> Dict[str, Any]:
        ...
        try:
            ...
            pairwise_to_three_body = total_pairwise / three_body_interaction if three_body_interaction > 0 else float('inf')
