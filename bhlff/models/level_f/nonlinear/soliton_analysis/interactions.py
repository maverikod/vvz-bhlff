...
class SolitonInteractionAnalyzer(SolitonAnalysisBase):
    ...
    def analyze_two_soliton_stability(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float) -> Dict[str, Any]:
        ...
        """
        return self.interaction_analyzer.analyze_two_soliton_stability(amp1, width1, pos1, amp2, width2, pos2)
    ...
    def analyze_three_soliton_interactions(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> Dict[str, Any]:
        ...
        """
        return self.interaction_analyzer.analyze_three_soliton_interactions(amp1, width1, pos1, amp2, width2, pos2, amp3, width3, pos3)
    ...
    def analyze_three_soliton_stability(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> Dict[str, Any]:
        ...
        """
        return self.interaction_analyzer.analyze_three_soliton_stability(amp1, width1, pos1, amp2, width2, pos2, amp3, width3, pos3)
    ...
    def _compute_full_mode_analysis(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> Dict[str, Any]:
        ...
        """
        return self.interaction_analyzer._compute_full_mode_analysis(amp1, width1, pos1, amp2, width2, pos2, amp3, width3, pos3)
    ...
    def _compute_interaction_matrix(self, x: np.ndarray, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> np.ndarray:
        ...
        return self.mode_analyzer._compute_interaction_matrix(x, amp1, width1, pos1, amp2, width2, pos2, amp3, width3, pos3)
    ...
    def _compute_mode_participation_ratios(self, eigenvectors: np.ndarray, profile1: np.ndarray, profile2: np.ndarray, profile3: np.ndarray) -> Dict[str, Any]:
        """Delegate to mode analyzer."""
        return self.mode_analyzer._compute_mode_participation_ratios(eigenvectors, profile1, profile2, profile3)
    ...
    def _compute_mode_splitting(self, eigenvalues: np.ndarray, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> float:
        """Delegate to mode analyzer."""
        return self.mode_analyzer._compute_mode_splitting(eigenvalues, amp1, width1, pos1, amp2, width2, pos2, amp3, width3, pos3)