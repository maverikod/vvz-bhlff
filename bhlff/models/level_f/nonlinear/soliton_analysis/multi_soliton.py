...
class MultiSolitonSolver(SolitonAnalysisBase):
    ...
    def _compute_two_soliton_energy(self, solution: np.ndarray, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float) -> float:
        """Delegate to core component."""
        return self.core.compute_two_soliton_energy(solution, amp1, width1, pos1, amp2, width2, pos2)
    ...
    def _compute_three_soliton_energy(self, solution: np.ndarray, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> float:
        """Delegate to core component."""
        return self.core.compute_three_soliton_energy(solution, amp1, width1, pos1, amp2, width2, pos2, amp3, width3, pos3)
    ...
    def _compute_final_two_soliton_solution(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float) -> Dict[str, Any]:
        ...
        return self.solutions._compute_final_two_soliton_solution(amp1, width1, pos1, amp2, width2, pos2)
    ...
    def _compute_final_three_soliton_solution(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> Dict[str, Any]:
        """Delegate to solutions component."""
        return self.solutions._compute_final_three_soliton_solution(amp1, width1, pos1, amp2, width2, pos2, amp3, width3, pos3)
    ...
    def compute_soliton_interaction_strength(self, amp1: float, width1: float, pos1: float, 
                                           amp2: float, width2: float, pos2: float) -> float:
        """Delegate to core component."""
        return self.core.compute_soliton_interaction_strength(amp1, width1, pos1, amp2, width2, pos2)
