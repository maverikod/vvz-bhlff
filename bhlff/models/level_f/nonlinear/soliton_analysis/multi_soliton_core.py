...
class MultiSolitonCore(SolitonAnalysisBase):
    ...
    def compute_7d_two_soliton_ode(self, x: np.ndarray, y: np.ndarray, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float) -> np.ndarray:
        """
    ...
    def compute_7d_three_soliton_ode(self, x: np.ndarray, y: np.ndarray, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> np.ndarray:
        """
    ...
    def compute_two_soliton_energy(self, solution: np.ndarray, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float) -> float:
        """
        ...
        try:
            ...
            interaction_energy = self.interaction_strength * amp1 * amp2 * self._step_resonator_interaction(distance, width1 + width2)
    ...
    def compute_three_soliton_energy(self, solution: np.ndarray, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float) -> float:
        """
        ...
        try:
            ...
            interaction_12 = self.interaction_strength * amp1 * amp2 * self._step_resonator_interaction(distance_12, width1 + width2)
            interaction_13 = self.interaction_strength * amp1 * amp3 * self._step_resonator_interaction(distance_13, width1 + width3)
            interaction_23 = self.interaction_strength * amp2 * amp3 * self._step_resonator_interaction(distance_23, width2 + width3)
            
            # Three-body interaction energy using 7D BVP step resonator theory
            total_distance = distance_12 + distance_13 + distance_23
            three_body_energy = self.three_body_strength * amp1 * amp2 * amp3 * self._step_resonator_interaction(total_distance, width1 + width2 + width3)
