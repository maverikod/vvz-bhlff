...
class MultiSolitonValidation(SolitonAnalysisBase):
    ...
    def validate_two_soliton_shape(self, solution: np.ndarray, amp1: float, width1: float, amp2: float, width2: float) -> bool:
        """
        ...
        """
        return self.core.validate_two_soliton_shape(solution, amp1, width1, amp2, width2)
    
    def validate_three_soliton_shape(self, solution: np.ndarray, amp1: float, width1: float, amp2: float, width2: float, amp3: float, width3: float) -> bool:
        """
        ...
        """
        return self.core.validate_three_soliton_shape(solution, amp1, width1, amp2, width2, amp3, width3)
    
    def validate_two_soliton_solution_quality(self, solution: Dict[str, Any], amp1: float, width1: float, amp2: float, width2: float) -> bool:
        """
        ...
        """
        return self.core.validate_two_soliton_solution_quality(solution, amp1, width1, amp2, width2)
    
    def validate_three_soliton_solution_quality(self, solution: Dict[str, Any], amp1: float, width1: float, amp2: float, width2: float, amp3: float, width3: float) -> bool:
        """
        ...
        Returns:
            bool: True if solution quality is acceptable.
        """
        return self.core.validate_three_soliton_solution_quality(solution, amp1, width1, amp2, width2, amp3, width3)
    ...
    def compute_two_soliton_physical_properties(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, solution: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return self.properties.compute_two_soliton_physical_properties(amp1, width1, pos1, amp2, width2, pos2, solution)
    ...
    def compute_three_soliton_physical_properties(self, amp1: float, width1: float, pos1: float, amp2: float, width2: float, pos2: float, amp3: float, width3: float, pos3: float, solution: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: Complete physical properties.
        """
        return self.properties.compute_three_soliton_physical_properties(amp1, width1, pos1, amp2, width2, pos2, amp3, width3, pos3, solution)