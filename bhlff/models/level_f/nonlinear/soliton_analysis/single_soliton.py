...
class SingleSolitonSolver(SolitonAnalysisBase):
    ...
    def validate_soliton_solution(self, solution: Dict[str, Any], amplitude: float, width: float) -> bool:
        """
    ...
    def compute_soliton_physical_properties(self, amplitude: float, width: float, position: float, solution: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        """
        return self.validator.compute_soliton_physical_properties(amplitude, width, position, solution)