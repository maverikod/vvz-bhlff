                ...
                try:
                    ...
                    def soliton_equations_7d(params):
                        ...
                        def soliton_ode(x, y):
                            ...
                            return self.core.compute_7d_soliton_ode(x, y, amplitude, width, position)
                        ...
                        try:
                            ...
                            if sol.success:
                                ...
                                energy = self.core.compute_soliton_energy(sol.y, amplitude, width)
                                ...
                                if not self.validator.validate_soliton_shape(sol.y, amplitude, width):
                                    return 1e10
                    ...
                    if result.success and result.fun < best_energy and result.fun < 1e9:
                        ...
                        if self.validator.validate_solution_quality(final_solution, amplitude, width):
                            best_solution = {
                                "type": "single",
                                "amplitude": amplitude,
                                "width": width,
