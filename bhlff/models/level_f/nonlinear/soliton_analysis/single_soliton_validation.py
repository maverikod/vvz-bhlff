...
class SingleSolitonValidation(SolitonAnalysisBase):
    ...
    def validate_soliton_shape(self, solution: np.ndarray, amplitude: float, width: float) -> bool:
        """
    ...
    def validate_solution_quality(self, solution: Dict[str, Any], amplitude: float, width: float) -> bool:
        """
