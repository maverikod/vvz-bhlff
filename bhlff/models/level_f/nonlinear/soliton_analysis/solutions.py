...
class SolitonAnalysisSolutions(SolitonAnalysisBase):
    ...
    def find_soliton_solutions(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if len(soliton_profiles) > 1:
                interaction_analysis = self.interaction_analyzer.analyze_interactions(multi_solitons)
    ...
    def calculate_solution_quality(self, soliton_profiles: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Stability analysis
            stable_solutions = sum(1 for s in soliton_profiles 
                                 if s.get("interaction_analysis", {}).get("collective_stability", False))
            stability_rate = stable_solutions / len(soliton_profiles) if soliton_profiles else 0
