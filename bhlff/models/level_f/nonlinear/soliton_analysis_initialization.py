...
class SolitonAnalysisInitialization(AbstractModel):
    ...
    def _setup_cubic_soliton_analysis(self) -> None:
        ...
        self.cubic_amplitude_range = self.nonlinear_params.get("cubic_amplitude_range", [0.1, 2.0])
        self.cubic_width_range = self.nonlinear_params.get("cubic_width_range", [0.5, 3.0])
    ...
    def _setup_quartic_soliton_analysis(self) -> None:
        ...
        self.quartic_amplitude_range = self.nonlinear_params.get("quartic_amplitude_range", [0.1, 2.0])
        self.quartic_width_range = self.nonlinear_params.get("quartic_width_range", [0.5, 3.0])
    ...
    def _setup_sine_gordon_soliton_analysis(self) -> None:
        ...
        Physical Meaning:
            ...
            in the nonlinear system.
        """
        self.sine_gordon_enabled = self.nonlinear_params.get("sine_gordon_enabled", True)
        self.sine_gordon_amplitude_range = self.nonlinear_params.get("sine_gordon_amplitude_range", [0.1, 2.0])
        self.sine_gordon_width_range = self.nonlinear_params.get("sine_gordon_width_range", [0.5, 3.0])
