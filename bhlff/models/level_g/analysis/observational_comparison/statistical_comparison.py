...
class StatisticalComparison:
    ...
    def perform_comparison(self, obs_data: Dict[str, Any], model_observables: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _compute_r_squared(self, obs_data: Dict[str, Any], model_observables: Dict[str, Any]) -> float:
