...
class ObservablePropertiesCalculator:
    ...
    def compute_observable_properties(self, phase_field: np.ndarray, 
                                   object_params: Dict[str, Any]) -> Dict[str, float]:
        """
        ...
        properties = {
            ...
            "effective_radius": self._compute_effective_radius(phase_field, object_params),
            "phase_energy": self._compute_phase_energy(phase_field, object_params),
            "topological_defect_density": self._compute_defect_density(phase_field, object_params),
        }

        return properties

    def _compute_effective_radius(self, phase_field: np.ndarray, 
                                object_params: Dict[str, Any]) -> float:
        """
    ...
    def _compute_phase_energy(self, phase_field: np.ndarray, 
                           object_params: Dict[str, Any]) -> float:
        """
    ...
    def _compute_nonlinear_energy(self, phase_field: np.ndarray, 
                                object_params: Dict[str, Any]) -> float:
        """
    ...
    def _compute_defect_density(self, phase_field: np.ndarray, 
                              object_params: Dict[str, Any]) -> float:
        """
