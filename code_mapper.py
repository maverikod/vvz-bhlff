...
class CodeMapper:
    ...
    def analyze_file(self, file_path: str) -> None:
        ...
        return self.core.analyze_file(file_path)
    ...
    def generate_issues_report(self) -> str:
        ...
        if not self.reports:
            raise RuntimeError("Must scan directory first")
        return self.reports.generate_issues_report()
    ...
    def generate_yaml_code_map(self) -> str:
        ...
        if not self.reports:
            raise RuntimeError("Must scan directory first")
        return self.reports.generate_yaml_code_map()
    ...
    def generate_yaml_issues_report(self) -> str:
        ...
        if not self.reports:
            raise RuntimeError("Must scan directory first")
        return self.reports.generate_yaml_issues_report()
    ...
    def generate_method_index(self) -> str:
        ...
        if not self.methods:
            raise RuntimeError("Must scan directory first")
        return self.methods.generate_method_index()
    ...
    def generate_yaml_method_index(self) -> str:
        ...
        if not self.methods:
            raise RuntimeError("Must scan directory first")
        return self.methods.generate_yaml_method_index()
