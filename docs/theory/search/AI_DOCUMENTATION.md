...
**Примеры:**
```bash
python3 search/search_theory_index.py --index ALL_index.yaml --mode stats
python3 search/search_theory_index.py --index ALL_index.yaml --mode stats --format json
```
...
**Примеры:**
```bash
python3 search/search_theory_index.py --index ALL_index.yaml --theory ALL.md --mode validate
```
...
```bash
# Поиск по ID
python3 search/search_theory_index.py --index ALL_index.yaml --mode search --tag "7d-93"

# Поиск по категории
python3 search/search_theory_index.py --index ALL_index.yaml --mode search --category "галактик"

# Поиск по фразе
python3 search/search_theory_index.py --index ALL_index.yaml --theory ALL.md --mode search --phrase "CMB"

# Использование пресета
python3 search/search_theory_index.py --index ALL_index.yaml --mode search --preset earth

# JSON вывод
python3 search/search_theory_index.py --index ALL_index.yaml --mode search --phrase "Θ-дефект" --format json
```
...
**Примеры:**
```bash
python3 search/search_theory_index.py \
...
**Примеры:**
```bash
python3 search/search_theory_index.py --index ALL_index.yaml --mode tree
```
...
**Примеры:**
```bash
python3 search/search_theory_index.py --index ALL_index.yaml --mode help
```
