...
sqlite3 docs/theory/ALL_theory_blocks.sqlite "SELECT id, category FROM view_cells LIMIT 10"
sqlite3 docs/theory/ALL_theory_blocks.sqlite "SELECT id, category FROM view_earth LIMIT 10"
sqlite3 docs/theory/ALL_theory_blocks.sqlite "SELECT id, category FROM view_driver LIMIT 10"
```
...
```python
import sqlite3
conn = sqlite3.connect('docs/theory/ALL_theory_blocks.sqlite')
cur = conn.cursor()
...
- Индекс: `docs/theory/ALL_index.yaml`
- Теория: `docs/theory/All.md`
- База: `docs/theory/ALL_theory_blocks.sqlite` (38MB, 100 сегментов)
- Скрипт: `docs/theory/search/search_theory_index.py`
- Карта теории: `docs/theory/theory_map.md` (создаётся через `sqlite_map`)
