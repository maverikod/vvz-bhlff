...
from bhlff.models.level_f import (
    MultiParticleSystem, CollectiveExcitations, 
    PhaseTransitions, NonlinearEffects
)
...
def visualize_results(system, excitations, transitions, nonlinear):
    ...
    im1 = axes[0, 0].imshow(potential[:, :, potential.shape[2]//2], 
...
def main():
    ...
    print(f"- Found {len(excitation_analysis['peaks']['frequencies'])} collective modes")
