...
2. **Сохранить FFT как основу**:
   - **НЕ ТРОГАТЬ** 41 файл в `core/fft/`
   - FFT - это основа системы (базовое поле = волны)
   - **НО**: FFT экспоненты ≠ BVP экспоненциальные решения

3. **🚨 ИСПРАВИТЬ экспоненциальную интеграцию**:
...
- **41 файл FFT** - основа системы (базовое поле = волны)
- **Экспоненциальные члены** - критически важны для BVP-теории
...
- **FFT как основа**: сохранение всех 41 файла спектральных операций
