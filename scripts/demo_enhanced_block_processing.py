...
def demonstrate_basic_block_processing():
    ...
    print(f"Processor initialized with block size: {processor.base_processor.block_size}")
...
def demonstrate_adaptive_processing():
    ...
    test_fields = [
        ("Small field", np.random.random((16, 16, 16)) + 1j * np.random.random((16, 16, 16))),
        ("Medium field", np.random.random((24, 24, 24)) + 1j * np.random.random((24, 24, 24))),
        ("Large field", np.random.random((32, 32, 32)) + 1j * np.random.random((32, 32, 32)))
    ]
