...
def test_beating_analysis_comprehensive():
    ...
    try:
        ...
        envelope = np.random.randn(*envelope_shape) + 1j * np.random.randn(*envelope_shape)
        ...
        print(f"  - Mode coupling strength: {results['mode_coupling']['coupling_strength']:.4f}")
        print(f"  - Phase coherence: {results['phase_coherence']['phase_coherence']:.4f}")
        print(f"  - Beating frequencies: {len(results['beating_frequencies']['beating_frequencies'])}")
        print(f"  - Theoretical consistency: {results['theoretical_validation']['theoretical_consistency']}")
        
        # Validate results structure
        required_keys = [
            'interference_patterns', 'mode_coupling', 'phase_coherence',
            'beating_frequencies', 'theoretical_validation', 'optimization_results'
        ]
...
def test_no_simplified_methods():
    ...
    try:
        ...
        # Check method names
        methods = [method for method in dir(BeatingAnalysisCore) if not method.startswith('_')]
        ...
        theoretical_methods = [method for method in methods if 'theoretical' in method.lower()]
