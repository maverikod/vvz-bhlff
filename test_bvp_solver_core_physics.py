...
def test_residual_computation_physics(solver_core, domain):
    ...
    # Physics checks
    assert residual.shape == solution.shape, "Residual should have same shape as solution"
    ...
    assert residual_magnitude > 0, "Residual should be non-zero for non-trivial solution"
...
def test_jacobian_computation_physics(solver_core, domain):
    ...
    # Physics checks
    assert jacobian.shape == solution.shape, "Jacobian diagonal should have same shape as solution"
...
def test_linear_system_solving_physics(solver_core, domain):
    ...
    # Physics checks
    assert correction.shape == residual.shape, "Correction should have same shape as residual"
...
def test_7d_coupling_physics():
    ...
    # Physics checks
    assert isinstance(contribution, (complex, float)), "Contribution should be complex or float"
