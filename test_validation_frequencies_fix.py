...
from bhlff.models.level_c.beating.validation_basic.beating_validation_frequencies import BeatingValidationFrequencies
...
def test_physical_frequency_validation():
    ...
    try:
        ...
        print(f"  - Theoretical valid: {result['theoretical_validation']['theoretical_valid']}")
        print(f"  - Harmonic relationships: {result['harmonic_analysis']['harmonic_count']}")
        
        # Validate results structure
        required_keys = [
            'frequencies_valid', 'frequency_errors', 'frequency_metrics',
            'physical_validation', 'theoretical_validation', 'harmonic_analysis'
        ]
...
def test_harmonic_analysis():
    ...
    try:
        ...
        assert result['harmonic_analysis']['harmonic_count'] > 0, "Should detect harmonic relationships"
        assert result['harmonic_analysis']['harmonic_valid'], "Should validate harmonics"
