...
class TestAcceptanceCriteria:
    ...
    def test_frac_1_energy_monotonicity(self, domain_3d):
        ...
        for i in range(1, len(energies)):
            ...
            assert delta_energy <= 0, f"FRAC-1 violation: ΔE={delta_energy} > 0 at separation {separations[i]}"
    ...
    def test_mass_terms_forbidden_in_base_regime(self, domain_3d):
        ...
        interactions_diagnostic = DefectInteractions(domain_3d, physics_params_diagnostic)
