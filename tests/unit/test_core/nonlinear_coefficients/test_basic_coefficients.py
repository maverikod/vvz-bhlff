...
class TestBasicCoefficients:
    ...
    def test_nonlinear_coefficients_creation(self, nonlinear_coeffs, domain_7d):
        ...
        assert np.isfinite(nonlinear_coeffs.chi_double_prime_0), "chi_double_prime_0 should be finite"
    ...
    def test_chi_coefficients(self, nonlinear_coeffs):
        ...
        assert nonlinear_coeffs.chi_double_prime_0 >= 0, "chi_double_prime_0 should be non-negative"
    ...
    def test_carrier_frequency(self, nonlinear_coeffs):
        ...
        # Should be finite
        assert np.isfinite(nonlinear_coeffs.carrier_frequency), "Carrier frequency should be finite"
        
        # Should be a reasonable value (not too large or too small)
        assert 1e40 < nonlinear_coeffs.carrier_frequency < 1e50, "Carrier frequency should be in reasonable range"
    ...
    def test_dimensional_consistency(self, nonlinear_coeffs):
        ...
        assert np.isfinite(nonlinear_coeffs.kappa_0 / nonlinear_coeffs.kappa_2), \
            "kappa_0 and kappa_2 should have consistent dimensions"
        
        # chi_prime and chi_double_prime_0 should have same dimensions
        assert np.isfinite(nonlinear_coeffs.chi_prime / nonlinear_coeffs.chi_double_prime_0), \
