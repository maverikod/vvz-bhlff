...
class TestBVPPostulatesCoverage:
    ...
    def test_bvp_postulates_validate_postulate_consistency(self, domain_7d, bvp_constants):
    ...
    def test_bvp_postulates_serialization(self, domain_7d, bvp_constants):
        ...
        new_postulates = BVPPostulates.from_dict(domain_7d, bvp_constants, postulates_dict)
