...
class TestFFTTwiddleComputer:
    ...
    def test_twiddle_computer_twiddle_factor_energy_conservation(self, twiddle_computer):
    ...
    def test_twiddle_computer_twiddle_factor_numerical_stability(self, twiddle_computer):
    ...
    def test_twiddle_computer_twiddle_factor_phase_relationships(self, twiddle_computer):
