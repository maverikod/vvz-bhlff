...
class TestFractionalLaplacianParameters:
    ...
    def test_parameters_object_with_custom_lambda(self, domain_7d, parameters_7d):
        ...
        """
        custom_lambda = 0.5
        laplacian = FractionalLaplacian(domain_7d, parameters_7d, lambda_param=custom_lambda)
    ...
    def test_spectral_coefficients_with_parameters_object(self, domain_7d, parameters_7d):
        """
    ...
    def test_validation_with_parameters_object(self, domain_7d):
        ...
        with pytest.raises(ValueError, match="Fractional order beta must be in \\(0,2\\)"):
    ...
    def test_consistency_between_initialization_methods(self, domain_7d, parameters_7d):
        ...
        laplacian_float = FractionalLaplacian(domain_7d, parameters_7d.beta, parameters_7d.lambda_param)
