...
from bhlff.core.domain.optimized_block_processor import OptimizedBlockProcessor, OptimizedConfig, ProcessingMode
...
class TestOptimizedBlockProcessing:
    ...
    def test_cpu_processing(self):
        """Test CPU processing."""
        field = np.random.random((3, 3, 3, 3, 3, 3, 3)) + 1j * np.random.random((3, 3, 3, 3, 3, 3, 3))
    ...
    def test_large_field_processing(self):
        ...
        # Create larger field
        field = np.random.random((5, 5, 5, 5, 5, 5, 5)) + 1j * np.random.random((5, 5, 5, 5, 5, 5, 5))
