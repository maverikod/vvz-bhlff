...
from tests.unit.test_core.test_frequency_dependent_properties_physics import (
    TestFrequencyDependentPropertiesPhysics,
)
from tests.unit.test_core.test_nonlinear_coefficients_physics import (
    TestNonlinearCoefficientsPhysics,
)
from tests.unit.test_core.test_renormalized_coefficients_physics import (
