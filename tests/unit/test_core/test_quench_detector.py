...
class TestQuenchDetector:
    ...
    def test_quench_threshold_validation(self, domain_7d):
        ...
        detector = QuenchDetector(domain_7d, energy_threshold=1e-3, rate_threshold=1e-2, magnitude_threshold=10.0)
        ...
        with pytest.raises(ValueError, match="Energy threshold must be positive"):
            QuenchDetector(domain_7d, energy_threshold=-1e-3, rate_threshold=1e-2, magnitude_threshold=10.0)
