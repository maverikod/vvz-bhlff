...
class TestBasicIntegrators:
    ...
    def test_envelope_integrator_creation(self, domain_7d, parameters_basic):
        ...
        assert (
            integrator.parameters == parameters_basic
    ...
    def test_integrator_consistency(self, domain_7d, parameters_basic):
        ...
        assert (
            exp_integrator.domain == cn_integrator.domain
        ), "Integrators should have same domain"
        assert (
            exp_integrator.parameters == cn_integrator.parameters
        ), "Integrators should have same parameters"
    ...
    def test_integrator_performance(self, domain_7d, parameters_basic):
        ...
        try:
            ...
            ), f"Integration took too long: {integration_time:.3f}s"
