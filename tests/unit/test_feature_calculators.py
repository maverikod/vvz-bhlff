...
class TestFeatureCalculator:
    ...
    def setup_method(self):
        ...
        self.test_envelope = np.random.random((32, 32, 32)) + 1j * np.random.random(
            (32, 32, 32)
        )
        self.test_envelope_2d = np.random.random((64, 64)) + 1j * np.random.random(
            (64, 64)
        )
    ...
    def test_frequency_spacing_calculation(self):
        ...
        spacing = self.calculator.calculate_frequency_spacing(
            self.test_envelope, (32, 32, 32)
        )
    ...
    def test_frequency_coupling_strength_calculation(self):
        ...
        coupling = self.calculator.calculate_frequency_coupling_strength(
            self.test_envelope
        )
    ...
    def test_mode_interaction_energy_calculation(self):
        ...
        # Test with 2D envelope
        energy_2d = self.calculator.calculate_mode_interaction_energy(
            self.test_envelope_2d
        )
    ...
    def test_large_array_handling(self):
        ...
        # Create large array
        large_envelope = np.random.random((100, 100, 100)) + 1j * np.random.random(
            (100, 100, 100)
        )
    ...
    def test_feature_calculation_consistency(self):
        ...
        features = {
            "spectral_entropy": self.calculator.calculate_spectral_entropy(
                self.test_envelope
            ),
            "frequency_spacing": self.calculator.calculate_frequency_spacing(
                self.test_envelope, (32, 32, 32)
            ),
            "frequency_bandwidth": self.calculator.calculate_frequency_bandwidth(
                self.test_envelope
            ),
            "autocorrelation": self.calculator.calculate_autocorrelation(
                self.test_envelope
            ),
            "coupling_strength": self.calculator.calculate_frequency_coupling_strength(
                self.test_envelope
            ),
            "interaction_energy": self.calculator.calculate_mode_interaction_energy(
                self.test_envelope
            ),
            "coupling_symmetry": self.calculator.calculate_coupling_symmetry(
                self.test_envelope
            ),
            "nonlinear_strength": self.calculator.calculate_nonlinear_strength(
                self.test_envelope
            ),
            "mixing_degree": self.calculator.calculate_mode_mixing_degree(
                self.test_envelope
            ),
            "coupling_efficiency": self.calculator.calculate_coupling_efficiency(
                self.test_envelope
            ),
        }
    ...
    def test_memory_efficiency(self):
        ...
        very_large_envelope = np.random.random((200, 200, 200)) + 1j * np.random.random(
            (200, 200, 200)
        )
