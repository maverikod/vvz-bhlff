...
class TestA02SimpleMultiFrequency:
    ...
    def create_multi_frequency_source(self, modes: List[list], amplitudes: List[complex]) -> np.ndarray:
    ...
    def test_spectral_analysis(self):
        ...
        assert peak_indices[:3] == expected_peak, \
    ...
    def test_energy_conservation(self):
        ...
        print(f"Test A0.2.4: Energy conservation - Source energy: {source_energy:.2e}, Solution energy: {solution_energy:.2e}")
