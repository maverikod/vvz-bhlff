...
class TestA03ZeroMode:
    ...
    def test_zero_mode_handling(self):
        ...
        try:
            ...
            assert "zero" in str(e).lower() or "singular" in str(e).lower() or \
                   "lambda" in str(e).lower() or "k=0" in str(e).lower(), \
    ...
    def test_zero_dc_source(self):
        ...
        assert solution_norm > 0, \
            "Solution should have non-zero norm"
    ...
    def test_operator_singularity(self):
        ...
        try:
            ...
            print("Test A0.3.6: Operator singularity - Constant field handled correctly")
            
        except Exception as e:
            # If exception is raised, it should be appropriate
            assert "zero" in str(e).lower() or "singular" in str(e).lower(), \
    ...
    def test_mixed_frequency_source(self):
        ...
        print(f"Test A0.3.7: Mixed frequency source - Solution norm: {solution_norm:.2e}")
    ...
    def test_error_messages(self):
        ...
        try:
            solution = self.solver.solve_stationary(source)
            print("Test A0.3.8: Error messages - Solver handled constant source without error")
            ...
            assert any(keyword in error_message for keyword in 
                      ['zero', 'lambda', 'singular', 'k=0', 'dc', 'constant']), \
