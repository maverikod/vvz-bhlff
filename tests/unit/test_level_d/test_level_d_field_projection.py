...
class TestFieldProjection:
    ...
    def test_em_projection(self, field_projection):
        ...
        # Create test field
        field = np.random.random(field_projection.domain.shape) + 1j * np.random.random(
            field_projection.domain.shape
        )
    ...
    def test_projection_comparison(self, field_projection):
        ...
        # Test comparison
        comparison = field_projection.compare_projections(
            em_projection, strong_projection
        )
    ...
    def test_multi_interaction_projection(self, field_projection):
        ...
        # Test multi-interaction projection
        multi_projection = field_projection.project_multi_interaction(
            field, ["em", "strong", "weak"]
        )
