...
class TestSolitonTopologyPhysicsBasic:
    ...
    def test_topological_charge_conservation(
        ...
        assert abs(charge_evolved - charge_initial) < physics_params["topological_charge_tolerance"]
    ...
    def test_topological_charge_scaling(self, physics_params):
        ...
        for i in range(1, len(charges)):
            assert abs(charges[i] - charges[0]) < physics_params["topological_charge_tolerance"]
    ...
    def test_topological_charge_under_rotation(
        ...
        assert abs(charge_rotated - charge_initial) < physics_params["topological_charge_tolerance"]
