...
class TestMultiParticleSystem:
    ...
    def test_three_body_interaction(self, system):
        ...
        third_particle = Particle(position=np.array([10.0, 5.0, 10.0]), charge=1, phase=np.pi/2)
        ...
        interaction = system._compute_three_body_interaction(particle_i, particle_j, particle_k)
    ...
    def test_system_with_single_particle(self, domain):
        ...
        """
        single_particle = [Particle(position=np.array([10.0, 10.0, 10.0]), 
                                  charge=1, phase=0.0)]
    ...
    def test_system_with_multiple_particles(self, domain):
        ...
        particles = [
            ...
            Particle(position=np.array([15.0, 15.0, 5.0]), charge=-1, phase=3*np.pi/2)
        ]
