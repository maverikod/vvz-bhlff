...
class TestMultiParticleSystemAdvanced:
    ...
    def test_get_phase_field_around_particle(self, system):
        ...
        with patch.object(system, '_extract_phase_field_around_particle') as mock_extract:
            mock_field = np.random.random((8, 8, 8, 4, 4, 4, 8)) + 1j * np.random.random((8, 8, 8, 4, 4, 4, 8))
    ...
    def test_extract_spherical_field(self, system):
        ...
        with patch.object(system, '_extract_spherical_field') as mock_spherical:
            mock_field = np.random.random((16, 16, 16)) + 1j * np.random.random((16, 16, 16))
    ...
    def test_collective_excitations(self, system):
        ...
        with patch.object(system.collective_modes, 'compute_excitations') as mock_excitations:
