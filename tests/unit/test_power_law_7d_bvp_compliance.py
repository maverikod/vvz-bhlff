...
class TestPowerLaw7DBVPCompliance:
    ...
    def test_advanced_power_law_fitting_methods(self, sample_region_data):
        ...
        result_curve_fit = fitting.fit_power_law_advanced(sample_region_data, method="curve_fit")
        ...
        result_minimize = fitting.fit_power_law_advanced(sample_region_data, method="minimize")
        assert result_minimize["fitting_method"] == "minimize"
        assert "fit_parameters" in result_minimize
        
        # Test custom method
        result_custom = fitting.fit_power_law_advanced(sample_region_data, method="custom")
