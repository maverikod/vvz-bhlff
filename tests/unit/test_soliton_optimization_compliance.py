...
from bhlff.models.level_f.nonlinear.soliton_analysis.solutions import (
...
class TestSolitonOptimizationCompliance:
    ...
    def test_no_exponential_decay_in_soliton_interactions(
        self, test_system, nonlinear_params
    ):
        """
        ...
        interaction_factor = solver._step_resonator_interaction(
        ...
        close_interaction = solver._step_resonator_interaction(
            close_distance, interaction_range
        )
        far_interaction = solver._step_resonator_interaction(
            far_distance, interaction_range
        )
    ...
    def test_full_energy_calculations_with_interactions(
        self, test_system, nonlinear_params
    ):
        """
    ...
    def test_7d_fractional_laplacian_implementation(
        self, test_system, nonlinear_params
    ):
        """
    ...
    def test_step_resonator_vs_exponential(self, test_system, nonlinear_params):
        ...
        for distance in distances:
            interaction = solver._step_resonator_interaction(
                distance, interaction_range
            )
